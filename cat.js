const BC_VER = 135e4;
var fandom, unit_buy, skill_file, SkillLevel, anim1, _eggs, enemy_descs, obtainid, rwMap, tfMap, def_lv, plus_lv, my_curve, _info, unit_orbs, orb_massive = 0,
  orb_resist = 1,
  orb_good_atk = 0,
  orb_good_hp = 1;
const ATK_SINGLE = 1,
...
function numStrT(num) {
  return "F" == _l_unit ? num.toString() + " F" : numStr(num / 30) + " 秒"
}
...
function getCover(p, durationF, attackF) {
  return p /= 100, durationF = (durationF /= attackF) - (attackF = ~~durationF), 100 * Math.min(1 - durationF * Math.pow(1 - p, 1 + attackF) - (1 - durationF) * Math.pow(1 - p, attackF), 1)
}
...
function get_trait_short_names(trait) {
  var trait_short_names = ["紅", "浮", "黑", "鐵", "天", "星", "死", "古", "無", "使徒", "魔女", "惡"],
    s = "";
  let i = 0;
  for (let x = 1; x <= TB_DEMON; x <<= 1) trait & x && (s += trait_short_names[i]), i++;
  return s
}
...
class Form {
  ...
  applyTalent(talent, level) {
    if (level) {
      var t, x, y, z, maxLv = talent[1] - 1,
        inc1 = ~~(talent[2] + --level * (talent[3] - talent[2]) / maxLv),
        inc2 = ~~(talent[4] + level * (talent[5] - talent[4]) / maxLv),
        inc3 = ~~(talent[6] + level * (talent[7] - talent[6]) / maxLv),
        inc4 = ~~(talent[8] + level * (talent[9] - talent[8]) / maxLv);
      switch (talent[0]) {
        case 1:
          x = inc2 + ((t = this.ab[AB_WEAK]) ? t[2] : 0), y = inc1 + (t ? t[0] : 0), z = (inc3 ? 100 - inc3 : 0) + (t ? t[1] : 0), this.ab[AB_WEAK] = [y, z, x];
          break;
        case 2:
          x = inc2 + ((t = this.ab[AB_STOP]) ? t[1] : 0), y = inc1 + (t ? t[0] : 0), this.ab[AB_STOP] = [y, x];
          break;
        case 3:
          x = inc2 + ((t = this.ab[AB_SLOW]) ? t[1] : 0), y = inc1 + (t ? t[0] : 0), this.ab[AB_SLOW] = [y, x];
          break;
        case 4:
        ...
        case 7:
          ...
          break;
        case 8:
          x = inc1 + ((t = this.ab[AB_KB]) ? t[0] : 0), this.ab[AB_KB] = [x];
          break;
        case 10:
          x = (t = this.ab[AB_STRONG]) ? t[0] : 100 - inc1, y = inc2 + (t ? t[1] : 0), this.ab[AB_STRONG] = [x, y];
          break;
        case 11:
          x = inc1 + ((t = this.ab[AB_LETHAL]) || 0), this.ab[AB_LETHAL] = x;
          break;
        case 12:
          this.ab[AB_ATKBASE] = null;
          break;
        case 13:
          x = inc1 + ((t = this.ab[AB_CRIT]) || 0), this.ab[AB_CRIT] = x;
          break;
        case 14:
          this.ab[AB_ZKILL] = null;
          break;
        case 15:
          x = inc1 + ((t = this.ab[AB_BREAK]) ? t[0] : 0), this.ab[AB_BREAK] = [x];
          break;
        case 16:
          this.ab[AB_BOUNTY] = null;
          break;
        case 17:
          x = inc1 + ((t = this.ab[AB_WAVE]) ? t[0] : 0), y = inc2 + (t ? t[1] : 0), this.ab[AB_WAVE] = [x, y];
          break;
        case 18:
        ...
        case 49:
          ...
          break;
        case 50:
          x = inc1 + ((t = this.ab[AB_S]) ? t[0] : 0), y = inc2 + (t ? t[1] : 0), this.ab[AB_S] = [x, y];
          break;
        case 51:
          x = inc1 + ((t = this.ab[AB_IMUATK]) ? t[0] : 0), y = inc2 + (t ? t[1] : 0), this.ab[AB_IMUATK] = [x, y];
          break;
        case 52:
        ...
        case 55:
          ...
          break;
        case 56:
          x = inc1 + ((t = this.ab[AB_VOLC]) ? t[0] : 0), y = inc2 + (t ? t[4] : 0), z = inc3 >> 2, this.ab[AB_VOLC] = [x, z, z + (inc4 >> 2), 20 * y, y];
          break;
        case 57:
          this.trait |= TB_DEMON;
          break;
        case 58:
          x = inc1 + ((t = this.ab[AB_SHIELDBREAK]) ? t[0] : 0), this.ab[AB_SHIELDBREAK] = [x];
          break;
        case 59:
          this.ab[AB_CKILL] = null;
          break;
        case 60:
          x = inc2 + ((t = this.ab[AB_CURSE]) ? t[1] : 0), y = inc1 + (t ? t[0] : 0), this.ab[AB_CURSE] = [y, x];
          break;
        case 61:
          this.tba = ~~(this.tba * (100 - inc1) / 100), this.attackF = (this.pre2 || this.pre1 || this.pre) + Math.max(this.backswing, this.tba - 1);
          break;
        case 62:
          x = inc1 + ((t = this.ab[AB_MINIWAVE]) ? t[0] : 0), y = inc2 + (t ? t[1] : 0), this.ab[AB_MINIWAVE] = [x, y];
          break;
        case 63:
        ...
        case 64:
          ...
          break;
        case 65:
          x = inc1 + ((t = this.ab[AB_MINIVOLC]) ? t[0] : 0), y = inc2 + (t ? t[4] : 0), z = inc3 >> 2, this.ab[AB_MINIVOLC] = [x, z, z + (inc4 >> 2), 20 * y, y];
          break;
        case 66:
  ...
  applySuperTalents(talents, levels) {
    let j = 0;
    for (let i = 0; i < 112 && talents[i]; i += 14) 1 == talents[i + 13] && this.applyTalent(talents.subarray(i, i + 14), levels[j++])
  }
  ...
  getbreak_prob() {
    var t = this.ab[AB_BREAK];
    return t ? t[0] : 0
  }
  getshield_break_prob() {
    var t = this.ab[AB_SHIELDBREAK];
    return t ? t[0] : 0
  }
  getmini_wave_prob() {
    var t = this.ab[AB_MINIWAVE];
    return t ? t[0] : 0
  }
  getwave_prob() {
    var t = this.ab[AB_WAVE];
    return t ? t[0] : 0
  }
  getmini_surge_prob() {
    var t = this.ab[AB_MINIVOLC];
    return t ? t[0] : 0
  }
  getsurge_prob() {
    var t = this.ab[AB_VOLC];
    return t ? t[0] : 0
  }
  getdodge_time() {
    var t = this.ab[AB_IMUATK];
    return t ? t[1] : 0
  }
  getdodge_prob() {
    var t = this.ab[AB_IMUATK];
  ...
  getstop_cover() {
    var t = this.ab[AB_STOP];
    return t ? getCoverUnit(this, t[0], this.trait & trait_treasure ? ~~(1.2 * t[1]) : t[1]) : 0
  }
  getslow_cover() {
    var t = this.ab[AB_SLOW];
    return t ? getCoverUnit(this, t[0], this.trait & trait_treasure ? ~~(1.2 * t[1]) : t[1]) : 0
  ...
  getweak_cover() {
    var t = this.ab[AB_WEAK];
    return t ? getCoverUnit(this, t[0], this.trait & trait_treasure ? ~~(1.2 * t[2]) : t[2]) : 0
  }
  getcurse_cover() {
    var t = this.ab[AB_CURSE];
    return t ? getCoverUnit(this, t[0], this.trait & trait_treasure ? ~~(1.2 * t[1]) : t[1]) : 0
  ...
  getatk() {
    var m = getLevelMulti(this.getTotalLv());
    let atk = ~~(~~(2.5 * Math.round(this.atk * m)) * this.atkM);
    return this.atk1 && (atk += ~~(~~(2.5 * Math.round(this.atk1 * m)) * this.atkM), this.atk2) && (atk += ~~(~~(2.5 * Math.round(this.atk2 * m)) * this.atkM)), atk
  }
  getattack() {
    return this.getatk()
  }
  ...
  getrange_interval_max() {
    if (this.atkType & ATK_OMNI || this.atkType & ATK_LD) {
      let x, r = this.lds[0],
        R = r + this.ldr[0];
      for (let i = 1; i < this.lds.length; ++i) x = this.lds[i], r = Math.max(r, x), R = Math.max(R, x + this.ldr[i]);
      return Math.abs(R - r)
    }
    return 0
  }
  ...
  getatkcount() {
    let c = 1;
    return this.pre1 && (c += 1, this.pre2) && (c += 1), c
  }
  gettdps() {
    let t = 0;
    for (var x of this._gettdps()) t += ~~x;
    return ~~(30 * t / this.attackF)
  }
  _gettdps() {
    var atks = this._getatks();
  ...
  _getatks() {
    var m = getLevelMulti(this.getTotalLv()),
      atks = [this.atk];
    this.atk1 && atks.push(this.atk1), this.atk2 && atks.push(this.atk2);
    for (let i = 0; i < atks.length; ++i) atks[i] = ~~(~~(Math.round(atks[i] * m) * atk_t) * this.atkM);
    return atks
  }
  gettatk() {
    let s = 0;
    for (const i of this._gettatk()) s += i;
    return s
  }
  mul(arr, s, ab = !0) {
    for (let i = 0; i < arr.length; ++i)(ab || this.abi & 1 << 2 - i) && (arr[i] *= s)
  }
  _gettatk() {
    var atks = this._getatks();
    return this.ab.hasOwnProperty(AB_ATKBASE) ? this.mul(atks, 1 + this.ab[AB_ATKBASE][0] / 100) : (this.ab.hasOwnProperty(AB_VOLC) ? this.mul(atks, 1 + this.ab[AB_VOLC][4], !1) : this.ab.hasOwnProperty(AB_MINIVOLC) && this.mul(atks, 1 + .2 * this.ab[AB_MINIVOLC][4], !1), this.ab.hasOwnProperty(AB_WAVE) ? this.mul(atks, 2, !1) : this.ab.hasOwnProperty(AB_MINIWAVE) && this.mul(atks, 1.2, !1), this.ab.hasOwnProperty(AB_S) && this.mul(atks, 1 + this.ab[AB_S][1] / 100, !1), this.ab.hasOwnProperty(AB_CRIT) && this.mul(atks, 2, !1), this.ab.hasOwnProperty(AB_STRONG) && this.mul(atks, 1 + this.ab[AB_STRONG][1] / 100), this.ab.hasOwnProperty(AB_EKILL) || this.ab.hasOwnProperty(AB_WKILL) ? this.mul(atks, 5) : (this.ab.hasOwnProperty(AB_MASSIVE) ? this.mul(atks, this.trait & trait_treasure ? 4 : 3) : this.ab.hasOwnProperty(AB_MASSIVES) && this.mul(atks, this.trait & trait_treasure ? 6 : 5), this.ab.hasOwnProperty(AB_GOOD) && this.mul(atks, this.trait & trait_treasure ? 1.8 : 1.5), this.ab.hasOwnProperty(AB_BSTHUNT) ? this.mul(atks, 2.5) : this.ab.hasOwnProperty(AB_BAIL) ? this.mul(atks, 1.6) : this.ab.hasOwnProperty(AB_SAGE) && this.mul(atks, 1.2))), atks
...
class CatInfo {
  ...
  loadAttitional(my_id) {
    ...
    for (var end, obt_id = obtainid[my_id], text = (null != obt_id && (this.obtain = obt_id), unit_buy), i = 0, start = 0; i < my_id;) {
      for (var j = start;
        "\n" != text[j]; ++j);
      start = j + 1, ++i
    }
    for (end = start;
      "\n" != text[end]; ++end);
    var amount, data = text.slice(start, end).split(",").map(x => parseInt(x));
    if (data[0] && (this.unclockS = data[0]), data[1] && (this.unclockFood = data[1]), rwMap.hasOwnProperty(my_id.toString()) && (this.rw = rwMap[my_id]), tfMap.hasOwnProperty(my_id.toString()) && (this.tf = tfMap[my_id]), this.rarity = data[13], this.maxBase = data[50], this.maxPlus = data[51], 1e5 <= (obt_id = data[data.length - 6]) && (this.version = obt_id), data[23] && (this.tfmethod = data[23]), data[27]) {
      this.upReqs = [
        [data[27], 0]
      ];
      for (let i = 28; i < 38; i += 2)(amount = data[i + 1]) && this.upReqs.push([amount, data[i]])
    }
    if (data[38]) {
      this.f4Reqs = [
        [data[38], 0]
      ];
      for (let i = 39; i < 49; i += 2)(amount = data[i + 1]) && this.f4Reqs.push([amount, data[i]])
    }
    this.crazed = 5e4 < data[3] && 3 == data[13], this.xp_data = data.slice(2, 12).join(","), _eggs = data.slice(data.length - 2), (obt_id = unit_orbs[my_id]) && (this.orbC = obt_id)
  }
  loadTalents(my_id) {
    if (-1 != (my_id = skill_file.indexOf(`
${my_id},`))) {
      ++my_id;
      let end;
      for (end = my_id;
...
class Cat {
  constructor(id, unit_file, curve, name, jp_name, desc, ic, t4) {
    if (id instanceof Object) {
      ...
      this.info = new CatInfo(id.info), this.curve = id.curve, this.ic = id.ic
    } else {
      this.curve = curve, this.info = new CatInfo(id, t4), this.forms = new Array(unit_file.length), this.ic = ic;
      for (let i = 0; i < unit_file.length; ++i) this.forms[i] = new Form(name[i] || "", jp_name[i] || "", desc[i], id, i, unit_file[i].split(",").map(x => parseInt(x)))
    }
  }
  init() {
...
async function getJSON(url) {
  url = await fetch(url);
  if (url.ok) return url.json();
  throw "load failed"
}
async function getText(url) {
  url = await fetch(url);
  if (url.ok) return url.text();
  throw "load failed"
}
  ...
  return new Promise(resolve => {
    ...
    req.onupgradeneeded = onupgradeneeded, req.onsuccess = function(event) {
      ...
      db.transaction(["cats"], "readwrite").objectStore("cats").get(id).onsuccess = function(event) {
        if (event = event.target.result) return (event = new Cat(event.data)).init(), resolve(event);
        getAllCats().then(cats => {
          var tx = db.transaction(["cats"], "readwrite"),
  ...
  return new Promise((resolve, reject) => {
    ...
    req.onupgradeneeded = onupgradeneeded, req.onsuccess = function(event) {
      ...
      db.transaction(["enemy"], "readwrite").objectStore("enemy").get(id).onsuccess = function(event) {
        if (event = event.target.result) return event.data ? resolve(new Enemy(event.data)) : reject();
        getAllEnemies().then(es => {
          var tx = db.transaction(["enemy"], "readwrite"),
    ...
    req.onupgradeneeded = onupgradeneeded, req.onsuccess = function(event) {
      ...
      db.transaction(["enemy"], "readwrite").objectStore("enemy").get(651).onsuccess = function(event) {
        if (event.target.result) {
          let es = new Array(695);
          db.transaction(["enemy"], "readwrite").objectStore("enemy").openCursor().onsuccess = function(event) {
            (event = event.target.result) ? (event.value.data && (es[event.value.id] = new Enemy(event.value.data)), event.continue()) : (resolve(es), db.close())
          }
  ...
  return new Promise(resolve => {
    ...
    req.onupgradeneeded = onupgradeneeded, req.onsuccess = function(event) {
      ...
      db.transaction(["cats"], "readwrite").objectStore("cats").get(717).onsuccess = function(event) {
        if (event.target.result) {
          let cats = new Array(762);
          db.transaction(["cats"], "readwrite").objectStore("cats").openCursor().onsuccess = function(event) {
            var c;
            (event = event.target.result) ? ((c = new Cat(event.value.data)).init(), cats[event.value.id] = c, event.continue()) : (resolve(cats), db.close())
          }
        } else getAllCats().then(cats => {
          var c, tx = db.transaction(["cats"], "readwrite"),
            store = tx.objectStore("cats");
          for (let i = 0; i < cats.length; ++i) store.put({
            id: i,
            data: cats[i].getObj()
...
function createImuIcons(imu, parent) {
  var names = ["波動傷害", "使動作停止", "使動作變慢", "打飛敵人", "烈波傷害", "攻擊力下降", "傳送", "古代的詛咒", "毒擊傷害", "魔王震波"],
    icon_names = ["MacWKW6", "OSjMN62", "rPx4aA2", "5CYatS4", "Uadt9Fa", "aN6I67V", "T7BXYAw", "27mAxhl", "5zleNqO", "4uYsoCg"];
  if (imu) {
    let i = 0,
      c = 0;
    for (let x = 1; x <= 512; x <<= 1, ++i)
      if (imu & x) {
        if (2 == ++c) {
          ...
          var texts = [];
          for (x = 1, i = 0; x <= 512; x <<= 1, ++i) imu & x && ((e = new Image(40, 40)).src = "https://i.imgur.com/" + icon_names[i] + ".png", p.appendChild(e), texts.push(names[i]));
          return p.append("無效（" + texts.join("、") + "）"), void parent.appendChild(p)
        }
        var e, p = document.createElement("div");
        (e = new Image(40, 40)).src = "https://i.imgur.com/" + icon_names[i] + ".png", p.appendChild(e), p.append(names[i] + "無效"), parent.appendChild(p)
      }
  }
}
...
function getAbiString(abi) {
  var strs;
  return abi ? (strs = [], 4 & abi && strs.push("一"), 2 & abi && strs.push("二"), 1 & abi && strs.push("三"), "，第" + strs.join(" / ") + "擊附加特性") : ""
}
